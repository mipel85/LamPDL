...
class LamdeskClubsController extends DefaultModuleController
{
    protected function get_template_to_use()
    {
        return new FileTemplate('lamdesk/LamdeskClubsController.tpl');
    }
    ...
    public function build_view(HTTPRequestCustom $request)
    {
        ...
        $this->view->assign_block_vars('clubs_ffam', array(
        ...
        $clubs_site = LamdeskService::count_clubs_site();
        $this->view->assign_block_vars('clubs_site', array(
        ...
        $clubs_planning = LamdeskService::count_clubs_planning();
        $this->view->assign_block_vars('clubs_planning', array(
        ...
        $clubs_requests = LamdeskService::count_clubs_requests();
        $this->view->assign_block_vars('clubs_request', array(
